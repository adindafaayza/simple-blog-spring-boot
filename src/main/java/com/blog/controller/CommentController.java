...
public class CommentController {
		...
		@GetMapping("/comments")
		List<Comment> getComments(@RequestParam("post_id") Long postId) {
...
//			log.info("id ::: " + id);
		...
		public List<Comment> getCommentsByKeyword(@RequestParam("post_id") Long postId, @RequestParam("query") String query) {
			List<Comment> comments = commentService.getCommentsByKeyword(postId, query);
			return comments;
		}
}
